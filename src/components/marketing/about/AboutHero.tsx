      ...
      <div className="container relative z-10">
        ...
        <div className="h-2"/>
          <motion.p variants={fadeUp()} className="t-body-lg max-w-[1250px] mx-auto">
            PulseIQ was built on a simple belief — that everyone deserves
            access to clear, reliable health information regardless of where
            they live, what they earn, or how much they know about medicine.
          </motion.p>
        </motion.div>
      </div>
    </section>
